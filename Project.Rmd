...
author: "Che Pam, Chen Yuqi, Shi Wennan, Zhang Haolin"
date: \today
fontsize: 11pt
output:
...
In this project, Che Pam and Chen Yuqi are mainly responsible for introduction, original time series, data transformation, and ETS model. Shi Wennan and Zhang Haolin are mainly responsible for ARIMA model, test, benefits and limitations of ETS vs ARIMA, and conclusion. In addition, all group members reviewed the code and report together, and made comments and suggestions. Everyone contributed equally.
